    ...
    public function run(): void
    {
        ...
        $permissions_arr = [
            ...
            'Users' => [
                ...
                'user impersonate' => 'Allow user to impersonate other user.',
            ],
            'Roles' => [
            ...
            'System' => [
                ...
                'trash bin' => 'Allow user to view and restore deleted data.',
            ],
            'Tickets' => [
                'ticket access' => 'Allow user to submit tickets and track their own.',
                'ticket assigner' => 'Allow user to assign tickets to other users.',
                'ticket responder' => 'Allow user to view all tickets, update status, assign, and respond.',
            ],
        ];
