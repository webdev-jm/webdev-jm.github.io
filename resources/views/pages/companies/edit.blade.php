...
@section('subtitle', __('adminlte::companies.update_company'))
@section('content_header_title', __('adminlte::companies.companies'))
@section('content_header_subtitle', __('adminlte::companies.update_company'))

{{-- Content body: main page content --}}
@section('content_body')
    {{ html()->form('POST', route('company.update', encrypt($company->id)))->open() }}

        <div class="card">
            <div class="card-header py-2">
                <div class="row">
                    <div class="col-lg-6 align-middle">
                        <strong class="text-lg">{{__('adminlte::companies.update_company')}}</strong>
                    </div>
