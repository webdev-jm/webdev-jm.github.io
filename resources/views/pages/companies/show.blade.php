...
@section('subtitle', __('adminlte::companies.company_details'))
@section('content_header_title', __('adminlte::companies.companies'))
@section('content_header_subtitle', __('adminlte::companies.company_details'))
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-6 align-middle">
                            <strong class="text-lg">{{__('adminlte::companies.company_details')}}</strong>
                        </div>
