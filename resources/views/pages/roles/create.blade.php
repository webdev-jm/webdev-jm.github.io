...
@section('subtitle', __('adminlte::roles.new_role'))
@section('content_header_title', __('adminlte::roles.roles'))
@section('content_header_subtitle', __('adminlte::roles.new_role'))
            ...
            <div class="card-header py-2">
                <div class="row">
                    <div class="col-lg-6 align-middle">
                        <strong class="text-lg">{{__('adminlte::roles.new_role')}}</strong>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="form-group">
                            ...
                            {{ html()->input('text', 'name', '')->placeholder(__('adminlte::roles.role_name'))->required(true)->class(['form-control', 'form-control-sm', 'is-invalid' => $errors->has('name')]) }}
